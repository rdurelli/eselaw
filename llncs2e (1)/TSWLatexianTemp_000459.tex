...
\usepackage{url}
\urldef{\mailsa}\path|{rdurelli, delamaro}@icmc.usp.br|    
\urldef{\mailsb}\path|{daniel.santibanez, bruno.marinho, raphael.honda, valter}@dc.ufscar.br|    
\urldef{\mailsc}\path|{Nicolas.Anquetil}@inria.fr|    
...
\titlerunning{Architecture-Driven Modernization: A Systematic Review}

\author{Rafael S. Durelli\inst{1, 3} 
\and Daniel M. Santib\'{a}\~{n}ez\inst{2} \and Bruno Marinho\inst{2} \and Raphael Honda\inst{2}\and\\
Nicolas Anquetil\inst{3}\and M\'{a}rcio E. Delamaro\inst{1} \and Valter V. de Camargo\inst{2}}

% the affiliations are given next; don't give your e-mail address
% unless you accept that it will be published
\institute{Computer Systems Department Universidade de S\~{a}o Paulo,\\
\mailsa\\
\and Department Computer Universidade Federal de S\~{a}o Carlos,\\
\mailsb
\and RMoD Team - INRIA,\\
\mailsc
}
